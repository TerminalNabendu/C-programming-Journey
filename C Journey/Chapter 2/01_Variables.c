...
//(Every line is an indipendent line not a code)
...
int j1 = a + j - i; // Valid: use previously defined variables, // int 1j is not valid (coz u cant start a variable with number first)
